...
function CalculateDot(typ)
	println(typeof(typ))
	#pierwszy wektor
	x = [convert(typeof(typ), 2.718281828), convert(typeof(typ), -3.141592654), convert(typeof(typ), 1.414213562), convert(typeof(typ), 0.5772156649), convert(typeof(typ), 0.3010299957)]
	#drugi wektor
